...
@Injectable()
export class MemberSubscriptionAuthGuard 
// implements CanActivate
 {
    // constructor(@InjectModel(AccountsSubscriptions.name) private readonly accountsSubscriptionsModel: Model<AccountsSubscriptionsDocument>) { }

    // async canActivate(context: ExecutionContext): Promise<boolean> {
    //     //delete any type later
    ...
    //     if (!hasSubscription)
    //         throw new ForbiddenException(i18n.t('auth.errors.to_use_the_service_please_prepare_our_monthly_subscription_first_thanks'))
